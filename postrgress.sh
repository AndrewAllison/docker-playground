...
PG_PRIMARY_PASSWORD=Fred$$1234
PG_DATABASE=testdb
PG_USER=pguser1
PG_PASSWORD=Fred$$1234
PG_ROOT_PASSWORD=Fred$$1234
PG_PRIMARY_PORT=5432
EOF

cat << EOF > pgadmin-env.list
PGADMIN_SETUP_EMAIL=andrew.allison@digitalinfamy.com
PGADMIN_SETUP_PASSWORD=Fred$$1234
SERVER_PORT=5050
EOF
